...
public class Plc4xSourceRecordProcessorTest {
    ...
    public void init() throws InitializationException {
    	...
    	testRunner.setProperty(Plc4xSourceRecordProcessor.REQUEST_TIMEOUT_IN_MILLISECONDS, "100");
    	testRunner.setProperty(Plc4xSourceRecordProcessor.MY_SERVICE, "simulated://127.0.0.1");
