...
public class Plc4xSinkRecordProcessorTest {
    ...
    public void init() throws InitializationException {
    	...
    	testRunner.setProperty(Plc4xSinkRecordProcessor.MY_SERVICE, "simulated://127.0.0.1");
        testRunner.setProperty(Plc4xSinkRecordProcessor.REQUEST_TIMEOUT_IN_MILLISECONDS, "1000");
