...
public class Plc4xListenRecordProcessorTest {
    ...
    public void init() throws InitializationException {
    	...
    	testRunner.setProperty(Plc4xListenRecordProcessor.REQUEST_TIMEOUT_IN_MILLISECONDS, "30000");
    	testRunner.setProperty(Plc4xListenRecordProcessor.MY_SERVICE, "simulated://127.0.0.1");
