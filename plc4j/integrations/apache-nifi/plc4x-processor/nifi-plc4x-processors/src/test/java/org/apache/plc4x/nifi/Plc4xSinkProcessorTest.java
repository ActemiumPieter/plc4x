...
public class Plc4xSinkProcessorTest {
    ...
    public void init() {
        ...
        testRunner.setProperty(Plc4xSinkProcessor.MY_SERVICE, "simulated://127.0.0.1");
        testRunner.setProperty(Plc4xSinkProcessor.REQUEST_TIMEOUT_IN_MILLISECONDS, "1000");
